export default {
  ...
  login: {
    ...
    oidcTab: 'Unified Login',
    localTab: 'Local Login',
    oidcTabTip: 'Sign in with your HAM Unified Auth account, no separate registration needed',
    oidcRedirectTip: 'You will be redirected to the HAM Unified Auth Platform to finish signing in',
